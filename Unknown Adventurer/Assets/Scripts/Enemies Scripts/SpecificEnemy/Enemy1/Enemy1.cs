...
public class Enemy1 : Entity
{
    ...
    public E1_DieState dieState { get; private set; }
    ...
    [SerializeField]
    private D_LookForPlayerStateData lookForPlayerStateData;
    [SerializeField]
    private D_MeleeAttackState meleeAttackStateData;
    [SerializeField]
    private D_StunStateData stunStateData;
    [SerializeField]
    private D_DieState dieStateData;
    [SerializeField]
    ...
    public override void Start()
    {
        ...
        dieState = new E1_DieState(this, stateMachine, "die", dieStateData, this);
